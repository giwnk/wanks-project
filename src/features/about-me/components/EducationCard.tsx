...
export default function EducationCard(data: Experience) {
  return (
    <div className="bg-card border-2 border-border p-5 shadow-retro hover-retro-lift flex flex-col gap-3">
      <div className="flex flex-wrap justify-between items-start gap-2">
        <div className="flex items-start gap-3">
          ...
          <div className="flex flex-col">
            <h3 className="font-sans text-base md:text-lg font-bold text-foreground leading-tight">
              {data.role}
            </h3>
            <span className="font-serif text-sm md:text-base font-semibold text-primary">
              {data.company}
            </span>
          </div>
        </div>
